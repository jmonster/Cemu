...
$qualifier = Join-Path $root 'dependencies/Switch2Kit/tests/emulator-launch/windows.ps1'
...
& $qualifier -Emulator cemu -Archive $Archive -Report $Report -ForbiddenRoot $ForbiddenRoot
